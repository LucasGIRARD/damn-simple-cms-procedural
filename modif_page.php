...
<p>Date de création : </p> le <input type='text' name='jour' size='1' maxlength='2' value=<?php echo  date('d', $timestamp);?> /> / <input type='text' name='mois' size='1' maxlength='2' value=<?php echo  date('m', $timestamp);?> /> / <input type='text' name='annee' size='2' maxlength='4' value=<?php echo  date('Y', $timestamp);?> /> à <input type='text' name='heure' size='1' maxlength='2' value=<?php echo  date('H', $timestamp);?> /> H <input type='text' name='minute' size='1' maxlength='2' value=<?php echo  date('i', $timestamp);?> />


<p>Date de la modification : </p> le <input type='text' name='jour_m' size='1' maxlength='2' value=<?php echo  date("d")?> /> / <input type='text' name='mois_m' size='1' maxlength='2' value=<?php echo  date("m")?> /> / <input type='text' name='annee_m' size='2' maxlength='4' value=<?php echo  date("Y")?> /> à <input type='text' name='heure_m' size='1' maxlength='2' value=<?php echo  date("H")?> /> H <input type='text' name='minute_m' size='1' maxlength='2' value=<?php echo  date("i")?> />
